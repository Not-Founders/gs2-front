...
set JOAO_NAME=Veronesi30
set JOAO_EMAIL=jvveronesi30@gmail.com
set LEO_NAME=LeoSabbatini
set LEO_EMAIL=leonardoherrerasabbatini@gmail.com
set RAFA_NAME=devfreitas
set RAFA_EMAIL=freitassrafa2006@gmail.com
